...
public partial class CredProspectarAux : System.Web.UI.Page
{
    ...
    void ValidaIndicador(TreeNode node)
    {
        ...
        for (int i = 0; i < node.ChildNodes.Count; i++)
        {
            ...
            if (hijo.Checked == true)
            {
                ...
                ds = sv.CredIndicadorMaxMinAux(int.Parse(this.CmbVigencia.SelectedValue), int.Parse(hijo.Value), int.Parse(Session["IDusuario"].ToString()));
    ...
    void ValidaPuc(TreeNode node)
    {
        ...
        for (int i = 0; i < node.ChildNodes.Count; i++)
        {
            ...
            if (hijo.Checked == true)
            {
                ...
                ds = sv.CredPucMaxMinAux(int.Parse(this.CmbVigencia.SelectedValue), int.Parse(hijo.Value), int.Parse(Session["IDusuario"].ToString()), Convert.ToInt32(Session["IdPais"].ToString()));
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        dsDatos = sv.CredProspectarAux(int.Parse(this.CmbVigencia.SelectedValue), this.HdIndicadores.Value, this.HdCiudad.Value, int.Parse(Session["IDusuario"].ToString()), Convert.ToInt32(Session["IdPais"].ToString()));
        ...
        for (i = 22; i <= cuantos; i++)
        {
            ListItem oItem = new ListItem("Cumplen " + (i - 22), (i - 22).ToString());
    ...
    protected void ImageButton7_Click(object sender, ImageClickEventArgs e)
    {
        ...
        string NomArchivo = "Propectacion" + int.Parse(Session["IDusuario"].ToString()) + ".xls";

...
public partial class Conf_PerfilOpciones : System.Web.UI.Page
{
    int[] lista = null;
    DataSet Dscompleto;
    ...
    private void Checkalo()
    {
        Datos sv = new Datos();
            ...
            for (i = 0; i < GridLista.Rows.Count; i++)
            {
                ...
                ds2 = sv.ExistePerfilMenu(int.Parse(this.CmbPerfil.SelectedValue), valor);
    ...
    protected void ImageButton19_Click(object sender, ImageClickEventArgs e)
    {
        Datos sv = new Datos();
            ...
            sv.EliminaMenuPerfil(int.Parse(this.CmbPerfil.SelectedValue));
            ...
            if ((lista != null))
            {
                for (i = 0; i < lista.Length; i++)
                {
                    ...
                    sv.IngresaMenuPerfil(int.Parse(this.CmbPerfil.SelectedValue), IdMenu);
                }
            }

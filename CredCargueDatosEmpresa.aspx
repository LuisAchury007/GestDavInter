<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GCredMaestra.master" CodeFile="CredCargueDatosEmpresa.aspx.cs" Inherits="CredCargueDatosEmpresa" Title=".:: Gestor Comercial y De Credito ::." StylesheetTheme="Tema1" Theme="Tema1" %>
                ...
                <table width="100%" border="0" cellpadding="4" cellspacing="4" bgcolor="#FFFFFF">
                    <tr>
                        <td valign="top" class="titulo01">
                            <asp:Label ID="lblTituloTblsParam" runat="server">Subir información a tabla empresas</asp:Label>
                        </td>
                    </tr>
                </table>
                <div class="container">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title panel-title-adjust">
                                            <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">
                                                <i class="fa fa-plus"></i>Actualizacion de campos grupo empresarial
                                            </a>
                                        </h4>
                                    </div>

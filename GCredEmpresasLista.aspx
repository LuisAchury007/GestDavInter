<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GCredMaestra.master" CodeFile="GCredEmpresasLista.aspx.cs" Inherits="GCredEmpresasLista" Title=".:: Gestor Comercial y De Credito ::." Theme="Tema1" StylesheetTheme="Tema1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%" class="areaBordes">
            <tr>
                <td class="titulo01">Empresas Cliente</td>
            </tr>
            <tr>
                <td class="titulo02">Descargar listado de clientes :: 
             <asp:ImageButton ID="ImageButton7" runat="server" ImageUrl="~/Grafix/Excel.png" OnClick="ImageButton7_Click" Style="width: 24px" />

<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GCredMaestra.master" CodeFile="CredActualizaOfac.aspx.cs" Inherits="CredActualizaOfac" Title=".:: Gestor Comercial y De Credito ::." Theme="Tema1" StyleSheetTheme="Tema1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="4" cellspacing="4" class="areaBordes" width="100%">
        <tr>
        <td valign="top" class="titulo01">
         Actualizar Lista Clinton</td>
        </tr>

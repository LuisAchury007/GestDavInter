<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/GCredMaestra.master" CodeFile="CredEliminarParcial.aspx.cs" Inherits="CredEliminarParcial" Title=".:: Gestor Comercial y De Credito ::." StylesheetTheme="Tema1" Theme="Tema1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table border="0" cellpadding="4" cellspacing="4" class="areaBordes" width="100%">
        <tr>
            <td valign="top" class="titulo01">Eliminar Parciales</td>
        </tr>
        <tr>
            <td>
        ...
        <asp:TextBox ID="txtBuscar" runat="server" CssClass="borders" Width="368px"></asp:TextBox>
                            ...
                            <asp:Button ID="Button1" runat="server" Text="Buscar" CssClass="botonDes" OnClick="Button1_Click" ValidationGroup="form" />
                        </td>
                    </tr>

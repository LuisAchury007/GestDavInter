...
public partial class LogIngresos : System.Web.UI.Page
{
    ...
    private void GrillaLlenar()
    {
        ...
        ds = sv.UsuarioIngresos(int.Parse(this.CmbUsuarios.SelectedValue));
    ...
    private void LLenardatos()
    {
        ...
        this.CmbUsuarios.DataSource = ds.Tables[0].DefaultView;

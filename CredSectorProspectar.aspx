<%@ Page Language="C#" MasterPageFile="~/GCredMaestra.master" AutoEventWireup="true" CodeFile="CredSectorProspectar.aspx.cs" Inherits="CredSectorProspectar" Title=".:: Prospectar ::." Theme="Tema1" StylesheetTheme="Tema1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="" style="width: 100%" border="0">
        <tr>
            <td class="tablaItem" style="width: 50%">Sector</td>
            <td class="tablaValor" style="width: 50%">
                <asp:DropDownList ID="cmbSector" CssClass="borders" runat="server"></asp:DropDownList>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:Label ID="Label73" runat="server" Text="Vigencia: "
                                                            Font-Names="Arial" Font-Size="12px" Font-Bold="True"></asp:Label><asp:DropDownList CssClass="borders" ID="CmbVigencia" runat="server"></asp:DropDownList>

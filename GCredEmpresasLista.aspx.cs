...
public partial class GCredEmpresasLista : System.Web.UI.Page
{
 DataSet Dscompleto;
    ...
    protected void ImageButton7_Click(object sender, ImageClickEventArgs e)
    {
        ...
        Datos sv = new Datos();
        dsDatos = sv.BencBuscarEmpresa("Todo", 3, Convert.ToInt32(Session["IdPais"].ToString()));
        
        string NomArchivo = "Clientes" + int.Parse(Session["IDusuario"].ToString()) + ".xls";

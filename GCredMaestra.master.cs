...
public partial class MaestraGC : System.Web.UI.MasterPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            lbUsuario.Text = Session["Usuario"].ToString() + " " + Session["Pais"].ToString();
    ...
    {
        Response.Redirect("GCredBuscador.aspx?Buscar=" + this.txtBuscar.Text);
    }

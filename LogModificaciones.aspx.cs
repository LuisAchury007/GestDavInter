...
public partial class LogModificaciones : System.Web.UI.Page
{
    DataSet Dscompleto;
    ...
    private void GrillaLlenar()
    {
        ...
        ds = sv.AuditoriaCargues(int.Parse(this.CmbUsuarios.SelectedValue), fun.Cononica(txtFechaI.Text), fun.Cononica(txtFechaF.Text));
    ...
    private void LLenardatos()
    {
        Datos sv = new Datos();
        DataSet ds = new DataSet();
        DataView vista2 = new DataView();


        ds = sv.UsuarioCombo();
        ds.Tables[0].Rows.Add("-1", " Todos Los Usuarios");
        vista2 = ds.Tables[0].DefaultView;
        vista2.Sort = "Nombre ASC";

        this.CmbUsuarios.DataSource = vista2;
        this.CmbUsuarios.DataTextField = "Nombre";
        this.CmbUsuarios.DataValueField = "IdUsuario";
